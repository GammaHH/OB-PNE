...
3. 變異數分析 ANOVA。
#### 6. 請寫出有幾種方法來計算 1st order absorption 的速率常數。(4)重複
>  殘值法、Wagner-nelson、Loo-Riegelman、尿液數據的 ka estimation。


### 小常識 BDF
#### 7. 定義生體可用率BA
表示治療的活性藥物達全身循環之速率與程度，且在作用部位發揮療效之量度。

##### 猜題：為何 low BA 副作用顯著？
因為生體可用率具個體差異，特別是BA低的高效價藥（Potent Drug），因而有顯著不同的體內濃度，濃度高則易引發副作用或毒性。
